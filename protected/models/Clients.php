...
class Clients extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name, nick, address, postalcode, nric, birthdate, nationality, res_tel, ofc_tel, mobile, email, company, designation, drvlicense_passdate, policy_id, v_model, v_type, engine_cap, yr_manufactured, reg_date, roadTax_expDate, carPlate, oldVehcNo, insuranceCo, oldNCD, prevExpDate, covPolicyNo, covCoverNoteNo, covCoverageType, covPlan, covGrossPrem, covNCD, covExcess, covWindScrAmnt, covLoadAmnt, covPersonalAcc, covExtension, covSurCharge, covOther1, covOther2, covOther3, covLoyaltyDis, covNCDProtectr, covCommDate, covExpDate, covInsurCo, covTermDate, spNameBroker, spAnnualPrem, spDiscount, spPremDue, spGST, spMiscChanges, spTotalDue, spComm1, spNetUnderwriter, spFirmComm, spAgentComm, spEarnings, spRemarks, spPaymentBy, spReceiptNo, dpDrverName, dpDrverICno, dpDrverOcc, dpDateBirth, dpDrverLcnsePass, dpDrverMarStat, dpGender, dpRelationship, dpNationality, dpWage, dpRemarks, dpRef, dpMonth', 'required'),
			array('policy_id, covNoClaim, spNameBroker, dpGender', 'numerical', 'integerOnly'=>true),
			array('name, address, company, designation, insuranceCo, covNCDProtectr, spPaymentBy, dpDrverName, dpRemarks', 'length', 'max'=>100),
			array('nick, nationality, covCoverNoteNo, spReceiptNo', 'length', 'max'=>30),
			array('postalcode, nric, covExcess, covWindScrAmnt, covLoadAmnt, covSurCharge, covLoyaltyDis, spAnnualPrem, spDiscount, spGST, spMiscChanges, spTotalDue, spComm1, spNetUnderwriter, spFirmComm, spAgentComm, spEarnings', 'length', 'max'=>10),
			array('res_tel, ofc_tel, mobile, engine_cap, yr_manufactured, carPlate, oldVehcNo, oldNCD, covPolicyNo, covPlan', 'length', 'max'=>20),
			array('email, v_model, v_type, covCoverageType, covPersonalAcc, covExtension, covOther1, covOther2, covOther3, covInsurCo, dpDrverICno, dpDrverOcc, dpRelationship, dpNationality, dpWage, dpRef, dpMonth', 'length', 'max'=>50),
			array('covGrossPrem, covNCD', 'length', 'max'=>11),
			array('spRemarks', 'length', 'max'=>200),
			array('dpDrverMarStat', 'length', 'max'=>15),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, nick, address, postalcode, nric, birthdate, nationality, res_tel, ofc_tel, mobile, email, company, designation, drvlicense_passdate, policy_id, v_model, v_type, engine_cap, yr_manufactured, reg_date, roadTax_expDate, carPlate, oldVehcNo, insuranceCo, oldNCD, prevExpDate, covPolicyNo, covCoverNoteNo, covCoverageType, covPlan, covGrossPrem, covNCD, covExcess, covWindScrAmnt, covLoadAmnt, covPersonalAcc, covExtension, covSurCharge, covOther1, covOther2, covOther3, covLoyaltyDis, covNoClaim, covNCDProtectr, covCommDate, covExpDate, covInsurCo, covTermDate, spNameBroker, spAnnualPrem, spDiscount, spPremDue, spGST, spMiscChanges, spTotalDue, spComm1, spNetUnderwriter, spFirmComm, spAgentComm, spEarnings, spRemarks, spPaymentBy, spReceiptNo, dpDrverName, dpDrverICno, dpDrverOcc, dpDateBirth, dpDrverLcnsePass, dpDrverMarStat, dpGender, dpRelationship, dpNationality, dpWage, dpRemarks, dpRef, dpMonth', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'dpDrverName' => 'Dp Drver Name',
			'dpDrverICno' => 'Dp Drver Icno',
			'dpDrverOcc' => 'Dp Drver Occ',
			'dpDateBirth' => 'Dp Date Birth',
			'dpDrverLcnsePass' => 'Dp Drver Lcnse Pass',
			'dpDrverMarStat' => 'Dp Drver Mar Stat',
			'dpGender' => 'Dp Gender',
			'dpRelationship' => 'Dp Relationship',
			'dpNationality' => 'Dp Nationality',
			'dpWage' => 'Dp Wage',
	...
	public function search()
	{
		...
		$criteria->compare('dpDrverName',$this->dpDrverName,true);
		$criteria->compare('dpDrverICno',$this->dpDrverICno,true);
		$criteria->compare('dpDrverOcc',$this->dpDrverOcc,true);
		$criteria->compare('dpDateBirth',$this->dpDateBirth,true);
		$criteria->compare('dpDrverLcnsePass',$this->dpDrverLcnsePass,true);
		$criteria->compare('dpDrverMarStat',$this->dpDrverMarStat,true);
		$criteria->compare('dpGender',$this->dpGender);
		$criteria->compare('dpRelationship',$this->dpRelationship,true);
		$criteria->compare('dpNationality',$this->dpNationality,true);
		$criteria->compare('dpWage',$this->dpWage,true);
		$criteria->compare('dpRemarks',$this->dpRemarks,true);
		$criteria->compare('dpRef',$this->dpRef,true);
		$criteria->compare('dpMonth',$this->dpMonth,true);
